...
storiesOf('Button', module)
	...
	.add('Plain button', () => (
		...
		>{text('Label', 'A simple button')}</Button>
	))
	.add('With shadow and gradient', () => (
		...
		>{text('Label', 'With shadow & gradient')}</Button>
	))
	.add('Custom gradient', () => (
		<Button
			...
			size={select('size', buttonSizes, 'regular')}
			shadow={boolean('shadow', true)}
		>{text('Label', 'Custom gradient')}</Button>
	))
	.add('Round with icon', () => (
		<Button
			round={true}
			...
			size={select('size', buttonSizes, 'regular')}
			shadow={boolean('shadow', true)}
		><Icon name={text('Icon name', 'pencil')} /></Button>
	))
	.add('Dispay block', () => (
		<Button
			block={boolean('block', true)}
		>I display block</Button>
	))
	.add('Custom dimensions', () => (
		<Button
			width={text('Width', '300px')}
			height={text('height', '300px')}
		>I can be any size and the text is centered and multiline</Button>
	))