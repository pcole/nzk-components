  ...
  _createClass(Button, [{
    ...
    value: function render() {
      ...
      props.style = _extends({
        ...
        backgroundImage: gradient || bgColorTo ? 'linear-gradient(to right, ' + bgColor + ', ' + (bgColorTo || bgColorObj.lighten(0.2).string()) + ')' : 'none'
      }, props.style);
      ...
      switch (element) {
        case 'span':
          return _react2.default.createElement(
            'span',
            _extends({}, props, {
              className: 'jsx-' + _Button2.default.__scopedHash + ' ' + (className || '')
            }),
            children,
...
Button.propTypes = {
  ...
  size: _propTypes2.default.oneOf(['x-mall', 'small', 'regular', 'large', 'x-large']),
