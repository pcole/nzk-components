...
var WritingTool = ((_dec = (0, _reactGsapEnhancer2.default)()),
  _dec(
    (_class = (function (_Component) {
      ...
      function WritingTool (props) {
        ...
        var _this = _possibleConstructorReturn(
          this,
          (WritingTool.__proto__ || Object.getPrototypeOf(WritingTool)).call(
            this,
            props
          )
        )
        ...
        _this.throttledCacheState = (0, _lodash.throttle)(
          _this.cacheState,
          1000,
          { leading: false }
        )
      ...
      _createClass(WritingTool, [
        ...
        },
        {
          ...
          value: function startAutoCache () {
            ...
            this.unsubscribe = store.subscribe(
              this.throttledCacheState.bind(this)
            )
          }
        },
        {
            ...
            if (!this.state.sidebarOpen) {
              ...
              return new _gsap.TimelineMax()
                .to(
                  left,
                  1,
                  { ease: _gsap.Bounce.easeOut, width: 'calc(100vw - 415px)' },
                  0
                )
                .to(right, 1, { ease: _gsap.Bounce.easeOut, width: '415px' }, 0)
            }
          }
        },
        {
        ...
        },
        {
          ...
          value: function onSave () {
            ...
            if (wordsUnder > 0) {
              warnDraftMessage = _react2.default.createElement(
                _reactIntl.FormattedMessage,
                {
                  id: 'writingToolWriteMore',
                  defaultMessage:
                  'Write at least {wordsUnder, plural, one {# more word} other {# more words}}!',
              ...
              warnDraftMessage = _react2.default.createElement(
                _reactIntl.FormattedMessage,
                {
                  ...
                  defaultMessage:
                  "Oops! That's too many words, take away at least {wordsOver, plural, one {# word} other {# words}}.",
              ...
              confirmModal: {
                message: _react2.default.createElement(
                  _reactIntl.FormattedMessage,
                  {
                    ...
                    defaultMessage:
                    "Are you sure? You will lose your work if you don't save it."
                  }
                ),
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                      'div',
                      {
                        className: 'column left sidebarOpen',
                        name: 'leftCol',
                        'data-jsx-ext': _WritingTool2.default.__scopedHash
                      },
                    ...
                    _react2.default.createElement(
                      'div',
                      {
                        className: 'column right sidebarOpen',
                        name: 'rightCol',
                        'data-jsx-ext': _WritingTool2.default.__scopedHash
                      },
                      _react2.default.createElement(
...
WritingTool.propTypes = {
  ...
  sections: _propTypes2.default.arrayOf(
