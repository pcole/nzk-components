...
var Section = (_dec = (0, _reactRedux.connect)(function (store, ownProps) {
  ...
  _createClass(Section, [{
    ...
    value: function onRemove(index) {
      this.props.dispatch((0, _actions.removeField)(this.props.index, index));
    }
  }, {
    key: 'onChange',
    value: function onChange(index, value) {
      this.props.dispatch((0, _actions.setFieldValue)(this.props.index, index, value));
    }
  }, {
    key: 'hostRef',
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { ref: this.hostRef.bind(this), style: hostStyle, className: 'jsx-' + _Section2.default.__scopedHash + ' ' + 'host'
        },
        _react2.default.createElement('h3', { dangerouslySetInnerHTML: { __html: this.props.title }, className: 'jsx-' + _Section2.default.__scopedHash
        }),
        _react2.default.createElement(
          'ul',
          {
            className: 'jsx-' + _Section2.default.__scopedHash + ' ' + 'fields'
          },
          ...
          this.props.userCanAddFields && _react2.default.createElement(
            'li',
            {
              className: 'jsx-' + _Section2.default.__scopedHash + ' ' + 'add-container'
            },
            _react2.default.createElement(
              _Button2.default,
              {
