...
var Field = (_dec = (0, _reactGsapEnhancer2.default)(), _dec(_class = function (_Component) {
  ...
  _createClass(Field, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      return this.state.value !== nextState.value || this.props.bgColor !== nextProps.bgColor;
    }
  }, {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'li',
        { style: hostStyle, className: 'jsx-' + _Field2.default.__scopedHash + ' ' + 'host'
        },
        ...
        this.props.type === 'textarea' && _react2.default.createElement('textarea', {
          ...
          className: 'jsx-' + _Field2.default.__scopedHash
        }),
        this.props.removable && _react2.default.createElement(
          'div',
          {
            className: 'jsx-' + _Field2.default.__scopedHash + ' ' + 'remove-button'
          },
