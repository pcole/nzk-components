...
var SpinnerModal = (function (_Component) {
  ...
  function SpinnerModal (props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (SpinnerModal.__proto__ || Object.getPrototypeOf(SpinnerModal)).call(
        this,
        props
      )
    )
    ...
    },
    {
      ...
      value: function render () {
        var _props = this.props,
          ...
          delayCloseTimeoutMS =
            _props$delayCloseTime === undefined ? 1000 : _props$delayCloseTime,
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            {
              className: 'host' + (this.state.fadeIn ? ' fadeIn' : ''),
              'data-jsx-ext': _SpinnerModal2.default.__scopedHash
            },
            _react2.default.createElement(
              'div',
              {
