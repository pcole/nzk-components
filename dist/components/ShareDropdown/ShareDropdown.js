  ...
  _createClass(ShareDropdown, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { style: hostStyle, className: 'jsx-' + _ShareDropdown2.default.__scopedHash + ' ' + 'host'
        },
        _react2.default.createElement(
          'div',
          {
            className: 'jsx-' + _ShareDropdown2.default.__scopedHash + ' ' + 'drop attached-top'
          },
          _react2.default.createElement('div', { style: style, className: 'jsx-' + _ShareDropdown2.default.__scopedHash + ' ' + 'arrow attached-top'
          }),
          _react2.default.createElement(
            'div',
            {
              className: 'jsx-' + _ShareDropdown2.default.__scopedHash + ' ' + 'drop-content'
            },
            _react2.default.createElement(
              'h4',
              {
                className: 'jsx-' + _ShareDropdown2.default.__scopedHash
              },
              'Share this with'
            ),
            _react2.default.createElement(
            ...
            _react2.default.createElement(
              'a',
              { href: 'http://facebook.com/nightzookeeper', target: '_blank', className: 'jsx-' + _ShareDropdown2.default.__scopedHash
              },
              _react2.default.createElement(_Icon2.default, { name: 'facebook', color: '#323091' })
            ),
            _react2.default.createElement(
              'a',
              { href: 'https://twitter.com/nightzookeeper', target: '_blank', className: 'jsx-' + _ShareDropdown2.default.__scopedHash
              },
              _react2.default.createElement(_Icon2.default, { name: 'twitter', color: '#3BABE6' })
            ),
            _react2.default.createElement(
              'a',
              { href: 'https://www.pinterest.com/nightzookeeper/', target: '_blank', className: 'jsx-' + _ShareDropdown2.default.__scopedHash
              },
