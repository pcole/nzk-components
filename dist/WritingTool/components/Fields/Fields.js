    ...
    (_class = (function (_Component) {
      ...
      function Fields (props) {
        ...
        var _this = _possibleConstructorReturn(
          this,
          (Fields.__proto__ || Object.getPrototypeOf(Fields)).call(this, props)
        )
      ...
      _createClass(Fields, [
        {
          ...
          value: function addField () {
            this.props.dispatch(
              _planningActions.addInput.bind(this, this.props.index)
            )
          }
        },
        {
        ...
        },
        {
          ...
          value: function removeAction (input) {
            this.props.dispatch(
              (0, _planningActions.removeInput)(this.props.index, input)
            )
          }
        },
        {
          ...
          value: function onChange (field, newValue) {
            this.props
              .onChange // Throttled save
              ()
            this.props.dispatch(
              (0, _planningActions.fieldChanged)(
                this.props.index,
                field,
                newValue
              )
          ...
          value: function render () {
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                this.props.fields[this.props.index].fields.map(function (
                  elem,
                  index
                ) {
                  return _react2.default.createElement(_Field2.default, {
                    ...
                    value:
                      _this2.props.fields[_this2.props.index].fields[index]
                        .value,
                    removeAction: _this2.removeAction.bind(_this2),
                    width: _this2.props.stacking
                      ? 'calc(' + 100 / _this2.props.nbPerRow + '% - 8px)'
                      : '100%',
                        ...
                        _Field2.default,
                        {
                          ...
                          onClick: function onClick () {
                            return _this2.props.dispatch(
                              (0, _planningActions.addInput)(_this2.props.index)
                            )
                          },
