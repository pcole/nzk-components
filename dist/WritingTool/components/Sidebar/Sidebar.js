...
var PromptContainer = (exports.PromptContainer = (function (_React$Component) {
  ...
  function PromptContainer (props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (PromptContainer.__proto__ || Object.getPrototypeOf(PromptContainer))
        .call(this, props)
    )
  ...
  _createClass(PromptContainer, [
    ...
    },
    {
      ...
      value: function render () {
        if (!this.state.image) return _react2.default.createElement('div', null)

        var imageClassName = (0, _classnames2.default)({
          'prompt-image': true,
    ...
    (_class = (function (_Component) {
      ...
      function Sidebar () {
        ...
        return _possibleConstructorReturn(
          this,
          (Sidebar.__proto__ || Object.getPrototypeOf(Sidebar))
