          ...
          function Writer (props) {
            ...
            _this.onDocumentChange = function (document, state) {
              ...
              if (count > _this.props.writing.nbWords) {
                // Addition
                if (
                  count / _this.props.writing.constraints.minNbWords * 50 >
                  50
                ) {
                  for (var i = 0; i < nbWords; i++) {
                    progress +=
                      _this.props.writing.constraints.minNbWords / (2 * count)
                  }
                } else {
                  progress =
                    count / _this.props.writing.constraints.minNbWords * 50
              ...
              _this.props.dispatch(
                (0, _writingActions.updateProgress)(progress)
              )
              _this.throttledSave()
            }
                          ...
                          style: {
                            ...
                            background:
                              ...
                              (_this.props.light
                                ...
                                : 'rgba(0,0,0,0.8)'),
                            borderBottom:
                              '5px solid ' + _this.props.primaryColor
                          },
                          value: _this.props.writing.title,
                          onChange: _this.handleTitleChange.bind(_this),
                          'data-jsx-ext': _Writer2.default.__scopedHash
                        })
                      )
                    : null,
                  ...
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                      _Button2.default,
                      {
                        bgColor: 'white',
                        shadow: true,
                        onClick: _this.saveAction.bind(_this)
                      },
                      'SAVE'
                    )
                  ),
            ...
            _this.renderEditor = function () {
              return _react2.default.createElement(
                ...
                _this.state.imagePopoverDisplayed
                  ? _this.renderImagePopover()
                  : null,
                _react2.default.createElement(_style2.default, {
                  styleId: _Writer2.default.__scopedHash,
                  css: _Writer2.default.__scoped
            ...
            _this.state = {
              state: _slate.Raw.deserialize(_this.props.writing.state, {
                terse: true
              }),
              wordCount: 0,
              mobile: false,
            ...
            },
            {
              ...
              value: function save () {
                if (this.props.writing.lastSave > 3) {
                  this.props.dispatch(
                    (0, _writingActions.saveWritingLocalstorage)()
                  )
                }
              }
            ...
            },
            {
              ...
              value: function print () {
                ...
                printWindow.document.write(
                  '<html><head><title>Writing Tool Export</title>'
                )
                printWindow.document.write(
                  '</head><body style="margin: 20px; max-width: calc(100vw - 40px);">'
                )
                var content =
                  '<div style="width: 100%; word-wrap: break-word;"><h1>' +
                ...
                printWindow.document.write(
                  '<footer>Created by NightZooKeeper</footer>'
                )
                printWindow.document.write(
                  '</body></html>'
                  // printWindow.print()
