        ...
        (_class = (function (_Component) {
          ...
          function Writer (props) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (Writer.__proto__ || Object.getPrototypeOf(Writer))
                .call(this, props)
            )
            ...
            _this.state = {
              ...
              writingState: _slate.Raw.deserialize(writingState, {
                terse: true
              }),
              mobile: false,
...
var _initialiseProps = function _initialiseProps () {
  ...
  this.onDocumentChange = function (document, state) {
    _this3.props.dispatch(
      (0, _actions.setWordCount)(_this3.getWordCountForState(state))
    )
  }
  ...
  this.render = function () {
    var hostStyle = {
      boxShadow:
        (_this3.props.light ? 'rgba(255,255,255,0.8)' : 'rgba(0,0,0,0.8)') +
        ' 0px 60px 59px 140px'
    }
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          {
            className:
              'title-container ' + (_this3.props.light ? 'light' : 'dark'),
  ...
  this.renderToolbar = function () {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _Button2.default,
            {
              ...
              shadow: true,
              round: true,
              onClick: _this3.props.onBack
                ? function () {
                  _this3.props.displayModal(
        ...
        !_this3.props.hideTextStyleButtons &&
          _this3.renderMarkButton('bold', 'bold'),
        !_this3.props.hideTextStyleButtons &&
          _this3.renderMarkButton('italic', 'italic'),
        !_this3.props.hideTextStyleButtons &&
          _this3.renderMarkButton('underlined', 'underline'),
        !_this3.props.hideAlignButtons &&
          _this3.renderBlockButton('align-left', 'align-left'),
        !_this3.props.hideAlignButtons &&
          _this3.renderBlockButton('align-center', 'align-center'),
        !_this3.props.hideAlignButtons &&
          _this3.renderBlockButton('align-right', 'align-right'),
        !_this3.props.hideImageButton &&
          _this3.renderBlockButton('image', 'picture-o'),
        _react2.default.createElement(
          'div',
          {
          ...
          _react2.default.createElement(
            _Button2.default,
            {
              bgColor: 'white',
              shadow: true,
              onClick: _this3.saveAction.bind(_this3)
            },
            'SAVE'
          )
        ),
        !_this3.props.hideClearButton &&
          _react2.default.createElement(
            'div',
            {
              className: 'toolbar-button save',
